...
local function useSlot(slot, noAnim)
    ...
    if data.weapon then
        TriggerEvent("rsg-weapons:client:UseWeapon", item, data.info.quality and data.info.quality > 0)
        TriggerEvent('inventory:client:ItemBox', Items, "use")
	end
